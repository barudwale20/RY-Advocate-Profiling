...
ActiveRecord::Schema.define(version: 20180531045507) do
  ...
  create_table "contact_tables", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "advocateId"
    t.string "firstName"
    t.string "lastName"
    t.string "email"
  ...
  create_table "crystal_tables", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "advocateId"
    t.text "sourceFile"
    t.string "crystalId"
    t.string "discType"
